...
class StochasticMaxURB(PrioritizedReplayBuffer):
    """
    A uniform replay buffer with Stochastic Maximum Threshold caching and
    ...
    def add_sample(self, sample, init_weight=None):
        ...
        if init_weight is None:
            ...
            if random.random() < new_error / self.errors.max(): # Stochastic
                self.transitions.append(sample)
                self.errors.append(new_error)
